package com.finalproject.gooddabackend.security;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://localhost:3000", "http://goodda.s3-website.ap-northeast-2.amazonaws.com", "http://goodda.co.kr")
